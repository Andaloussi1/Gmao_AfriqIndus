<template>
    ...
    <AppLayout title=" Article">
        ...
        <div class="flex justify-center">
            <div class="block p-6 rounded-lg shadow-lg bg-white max-w-screen-xl">
                ...
                <form @submit.prevent="form.post(route('articles.store'))">
                    ...
                    <div>
                        ...
                        <div>
                            <input ref="filePicker" type="file" :accept="accept" class="hidden" @change="change" multiple>
                            <button type="button" class="inline-flex items-center rounded-full p-2 hover:bg-blue-100 text-blue-500 focus:outline-none" @click="browse">
